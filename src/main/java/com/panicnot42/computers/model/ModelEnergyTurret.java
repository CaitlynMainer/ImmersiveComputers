...
public class ModelEnergyTurret extends ModelBase {
	...
	{
		setRotateAngle(rotorLeft, 0, yaw, 0);
		setRotateAngle(rotorRight, 0, yaw, 0);
		setRotateAngle(rotorBase, 0, yaw, 0);
		setRotateAngle(gunEnd, pitch, yaw, 0);
		setRotateAngle(gunBase, pitch, yaw, 0);
		setRotateAngle(gunBarrell, pitch, yaw, 0);
